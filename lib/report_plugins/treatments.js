...
treatments.report = function report_treatments(datastorage, sorteddaystoshow, options) {
  ...
  table.addClass('table table-sm table-striped table-hover table-bordered');
  ...
  sorteddaystoshow.forEach(function (day) {
    ...
    let tableHeader = $('<thead>')
      ...
      .append($('<tr>')
        .append($('<td>').attr('colspan', 14).append(report_plugins.utils.localeDate(day))))
      .append($('<tr>')
        .append($('<th>'))
        .append($('<th>').append(translate('Time')))
        .append($('<th>').append(translate('Event Type')))
        .append($('<th>').addClass('d-none d-xxl-table-cell').append(translate('Blood Glucose')))
        .append($('<th>').append(translate('Insulin')))
        .append($('<th>').append(translate('Carbs/Food/Time')))
        .append($('<th>').addClass('d-none d-xxl-table-cell').append(translate('Protein')))
        .append($('<th>').addClass('d-none d-xxl-table-cell').append(translate('Fat')))
        .append($('<th>').append(translate('Duration')))
        .append($('<th>').addClass('d-none d-xxl-table-cell').append(translate('Percent')))
        .append($('<th>').append(translate('Basal value')))
        .append($('<th>').addClass('d-none d-xxl-table-cell').append(translate('Profile')))
        .append($('<th>').addClass('d-none d-xxl-table-cell').append(translate('Entered By')))
        .append($('<th>').addClass('d-none d-xxl-table-cell').append(translate('Notes'))));
    ...
    for (const treatment of treatments) {
      ...
      tableBody.append($('<tr>')
        ...
        .append($('<td>').addClass('d-none d-xxl-table-cell number').append(treatment.glucose ? treatment.glucose + ' (' + translate(treatment.glucoseType) + ')' : ''))
        .append($('<td>').addClass('number').append(treatment.insulin ? treatment.insulin.toFixed(2) : ''))
        .append($('<td>').addClass('text').append(carbs))
        .append($('<td>').addClass('d-none d-xxl-table-cell number').append(treatment.protein ? treatment.protein : ''))
        .append($('<td>').addClass('d-none d-xxl-table-cell number').append(treatment.fat ? treatment.fat : ''))
        .append($('<td>').addClass('number').append(treatment.duration ? treatment.duration.toFixed(0) : ''))
        .append($('<td>').addClass('d-none d-xxl-table-cell number').append(treatment.percent ? treatment.percent : ''))
        .append($('<td>').addClass('number').append('absolute' in treatment ? treatment.absolute.toFixed(2) : ''))
        .append($('<td>').addClass('d-none d-xxl-table-cell text').append(treatment.profile ? treatment.profile : ''))
        .append($('<td>').addClass('d-none d-xxl-table-cell text').append(treatment.enteredBy ? treatment.enteredBy : ''))
        .append($('<td>').addClass('d-none d-xxl-table-cell text').append(treatment.notes ? treatment.notes : '')))
      dayHasData = true
    }
    if (dayHasData) {
